...
public class ItemBuilder {
	...
	public ItemBuilder setLore(String... lore) {
		ItemMeta im = is.getItemMeta();
		im.setLore(Utils.color(Arrays.asList(lore)));
		is.setItemMeta(im);
		return this;
	}
	...
	public ItemBuilder addLoreLines(List<String> lines) {
		...
		if (im.hasLore())
			lore = new ArrayList<>(im.getLore());
		lore.addAll(Utils.color(lines));
		im.setLore(lore);
		is.setItemMeta(im);
		return this;
	}

	public ItemBuilder addLoreLines(List<String> lines, int index) {
		ItemMeta im = is.getItemMeta();
		List<String> lore = new ArrayList<>();
		if (im.hasLore())
			lore = new ArrayList<>(im.getLore());
		lore.addAll(index, Utils.color(lines));
		im.setLore(lore);
		is.setItemMeta(im);
		return this;
	}
