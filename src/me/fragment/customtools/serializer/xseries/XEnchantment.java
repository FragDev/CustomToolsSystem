package me.fragment.customtools.serializer.xseries;
...
/**
 * Enchantment support with multiple aliases. Uses EssentialsX enchantment list
 * for aliases. Enchantment levels do not start from 0, they start from 1
 * <p>
 * EssentialsX Enchantment:
...
public enum XEnchantment {
	ARROW_DAMAGE("POWER", "ARROW_DAMAGE", "ARROW_POWER", "AD"), ARROW_FIRE("FLAME", "FLAME_ARROW", "FIRE_ARROW", "AF"),
	ARROW_INFINITE("INFINITY", "INF_ARROWS", "INFINITE_ARROWS", "INFINITE", "UNLIMITED", "UNLIMITED_ARROWS", "AI"),
	ARROW_KNOCKBACK("PUNCH", "ARROW_KNOCKBACK", "ARROWKB", "ARROW_PUNCH", "AK"), BINDING_CURSE(true, "BINDING_CURSE", "BIND_CURSE", "BINDING", "BIND"),
	CHANNELING(true, "CHANNELLING", "CHANELLING", "CHANELING", "CHANNEL"), DAMAGE_ALL("SHARPNESS", "ALL_DAMAGE", "ALL_DMG", "SHARP", "DAL"),
	DAMAGE_ARTHROPODS("BANE_OF_ARTHROPODS", "ARDMG", "BANE_OF_ARTHROPOD", "ARTHROPOD", "DAR"), DAMAGE_UNDEAD("SMITE", "UNDEAD_DAMAGE", "DU"), DEPTH_STRIDER(true, "DEPTH", "STRIDER"),
	DIG_SPEED("EFFICIENCY", "MINE_SPEED", "CUT_SPEED", "DS", "EFF"), DURABILITY("UNBREAKING", "DURA"), FIRE_ASPECT(true, "FIRE", "MELEE_FIRE", "MELEE_FLAME", "FA"),
	FROST_WALKER(true, "FROST", "WALKER"), IMPALING(true, "IMPALE", "OCEAN_DAMAGE", "OCEAN_DMG"), SOUL_SPEED(true, "SPEED_SOUL", "SOUL_RUNNER"), KNOCKBACK(true, "K_BACK", "KB"),
	LOOT_BONUS_BLOCKS("FORTUNE", "BLOCKS_LOOT_BONUS", "FORT", "LBB"), LOOT_BONUS_MOBS("LOOTING", "MOB_LOOT", "MOBS_LOOT_BONUS", "LBM"), LOYALTY(true, "LOYAL", "RETURN"),
	LUCK("LUCK_OF_THE_SEA", "LUCK_OF_SEA", "LUCK_OF_SEAS", "ROD_LUCK"), LURE(true, "ROD_LURE"), MENDING(true), MULTISHOT(true, "TRIPLE_SHOT"),
	OXYGEN("RESPIRATION", "BREATH", "BREATHING", "O2", "O"), PIERCING(true), PROTECTION_ENVIRONMENTAL("PROTECTION", "PROTECT", "PROT"),
	...
	PROTECTION_PROJECTILE("PROJECTILE_PROTECTION", "PROJECTILE_PROTECTION", "PROJ_PROT", "PP"), QUICK_CHARGE(true, "QUICKCHARGE", "QUICK_DRAW", "FAST_CHARGE", "FAST_DRAW"),
	RIPTIDE(true, "RIP", "TIDE", "LAUNCH"), SILK_TOUCH(true, "SOFT_TOUCH", "ST"), SWEEPING_EDGE("SWEEPING", "SWEEPING_EDGE", "SWEEP_EDGE"),
	THORNS(true, "HIGHCRIT", "THORN", "HIGHERCRIT", "T"), VANISHING_CURSE(true, "VANISHING_CURSE", "VANISH_CURSE", "VANISHING", "VANISH"),
	...
	/**
	 * Entity types that {@link #DAMAGE_ARTHROPODS} enchantment is effective
	 * against. This set is unmodifiable.
	 *
	 * @since 1.2.0
	 */
	...
	/**
	 * If an enchantment has {@code self} as true, it means that the vanilla
	 * enchantment name matches the Bukkit name.
	 *
	...
	XEnchantment(boolean self, @Nonnull String... aliases) {
		...
		this.name = self ? this.name() : aliases[0];
	}
	 ...
	 *
	 * @return true if smite enchantment is effective against the mob, otherwise
	 *         false.
	 * @since 1.1.0
	 */
	...
	/**
	 * Checks if {@link #DAMAGE_ARTHROPODS Bane of Arthropods} is effective against
	 * this type of mob.
	 *
	 * @param type the type of the mob.
	 *
	 * @return true if Bane of Arthropods enchantment is effective against the mob,
	 *         otherwise false.
	 * @since 1.1.0
	 */
	...
	/**
	 * Gets an enchantment from Vanilla and bukkit names. There are also some
	 * aliases available.
	 *
	 ...
	 * </blockquote>
	 * <p>
	 * Note that if you set your item's meta {@link ItemStack#setItemMeta(ItemMeta)}
	 * the enchantment will be removed. You need to use
	 * {@link ItemMeta#addEnchant(Enchantment, int, boolean)} instead. You can use
	 * the {@link #matchXEnchantment(String)} method in this case.
	 *
	 * @param item        the item to add the enchantment to.
	 * @param enchantment the enchantment string containing the enchantment name and
	 *                    level (optional)
	 *
	 * @return an enchanted {@link ItemStack} or the item itself without enchantment
	 *         added if enchantment type is null.
	...
	/**
	 * Checks if this enchantment is supported and registered in the current
	 * Minecraft version.
	 * <p>
	 * An invocation of this method yields exactly the same result as the
	 * expression:
	 * <p>
	 * <blockquote> {@link #parseEnchantment()} != null </blockquote>
	 *
